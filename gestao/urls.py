...
from .views import  Homegestor, Dashboard, Pesquisagestao, Perfil, create_user_view, configuracao_view,IntegracaoListView,IntegracaoCreateView, authorize,callback,get_refresh_token, get_price_info, get_create_product,get_anuncios,MercadoLivreAnuncios,IntegracaoDeleteView
...
urlpatterns = [
    ...
    path('integracoes/delete/<int:pk>', IntegracaoDeleteView.as_view(template_name='integracao_confirm_delete.html'), name='integracao_delete'),
